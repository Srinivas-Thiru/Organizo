...
import AddCardModal from './profile/components/AddCardModal'
import Board from './profile/components/Board/Board'
import BoardList from './profile/components/BoardList'
import Card from './profile/components/Card'
import HomePage from './profile/components/HomePage'
import SideNav from './profile/components/SideNav'
...
export default async function Home() {
  ...
  return (
    <div>
      <HomePage boardsData={boardsData} session={userDetials} boardsArray={filteredBoards} allUsers={allUsers} />
